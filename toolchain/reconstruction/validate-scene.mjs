...
const evidenceCatalog = loadEvidenceCatalog(spatialPlan.source.mapEvidence);
...
const { evidenceFactIds } = validateEvidenceCatalog(evidenceCatalog, {
  expectedRevision: spatialPlan.source.writingRevision,
  fail,
});
const assertPartOneSourceReferences = createSourceReferenceAsserter({
  evidenceFactIds,
  fail,
});
